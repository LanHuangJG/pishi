package pishi.gradle.plugin.asm;
...
public final class RobustAsmUtils {
    ...
    public final static String REDIRECTCLASSNAME = Type.getDescriptor(com.pishi.hotfix.ChangeQuickRedirect.class);
    public final static String PROXYCLASSNAME = "com.pishi.hotfix.PatchProxy".replace(".", "/");
    ...
    public static void createInsertCode(GeneratorAdapter mv, String className, List<Type> args, Type returnType, boolean isStatic, int methodId) {
        ...
        mv.visitMethodInsn(Opcodes.INVOKESTATIC,
                PROXYCLASSNAME,
                "proxy",
                "([Ljava/lang/Object;Ljava/lang/Object;" + REDIRECTCLASSNAME + "ZI[Ljava/lang/Class;Ljava/lang/Class;)Lcom/pishi/hotfix/PatchProxyResult;",
                false);

        int local = mv.newLocal(Type.getType("Lcom/pishi/hotfix/PatchProxyResult;"));
        mv.storeLocal(local);
        mv.loadLocal(local);

        mv.visitFieldInsn(Opcodes.GETFIELD, "com/pishi/hotfix/PatchProxyResult", "isSupported", "Z");
        ...
        if ("V".equals(returnType.getDescriptor())) {
            ...
            mv.loadLocal(local);
            mv.visitFieldInsn(Opcodes.GETFIELD, "com/pishi/hotfix/PatchProxyResult", "result", "Ljava/lang/Object;");
            //强制转化类型
