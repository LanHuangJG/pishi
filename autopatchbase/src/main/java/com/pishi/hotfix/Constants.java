...
public class Constants {
    ...
    public static final String MODIFY_ANNOTATION = "com.pishi.hotfix.patch.annotaion.Modify";
    //    public static final String MODIFY_ANNOTATION = Modify.class.getCanonicalName();
    public static final String ADD_ANNOTATION = "com.pishi.hotfix.patch.annotaion.Add";
    //    public static final String ADD_ANNOTATION = Add.class.getCanonicalName();
    public static final String LAMBDA_MODIFY = "com.pishi.hotfix.patch.RobustModify";
    //    public static final String LAMBDA_MODIFY = RobustModify.class.getCanonicalName();

    public static final String PATCH_TEMPLATE_FULL_NAME = "com.pishi.hotfix.utils.PatchTemplate";


    public static final String ZIP_FILE_NAME = "patch-classes.jar";
    ...
    public static final String ROBUST_UTILS_FULL_NAME = "com.pishi.hotfix.utils.EnhancedRobustUtils";
    ...
    public static final String PATCH_PACKAGENAME = "com.pishi.hotfix.patch";
